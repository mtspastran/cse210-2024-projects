...
class Program
{
    static void Main(string[] args)
    {
        ...
        // Video 1
        Video video1 = new Video("Living in the Heart of Argentina: Exploring Ancient Ruins", "Juan Perez Garcia", 480);
        ...
        // Video 2
        Video video2 = new Video("Hidden Gems of Argentina: Uncovering Mysteries in the Andes", "Jhon Mercedes Palomino", 975);
        ...
        Comment video2Comment3 = new Comment("Camila", "The views are simply breathtaking. I'm proud to be Argentinian.");
        ...
        // Video 3
        Video video3 = new Video("Argentinian Cuisine: A Gastronomic Adventure", "Miriam Velasquez Soto", 650);
        ...
        Comment video3Comment3 = new Comment("Fernando", "Argentinian food is famous worldwide, and your videos perfectly capture its essence.");
